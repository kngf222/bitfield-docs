...
<div className="bf-grid">
  ...
  <div className="bf-card">
    <strong>Copy the Runtime Kit Cookbook</strong>
    Runtime Kit Cookbook entries show complete package files and app calls without pulling private product implementation details into public docs.
  </div>
  <div className="bf-card">
