...
<div className="bf-grid">
  ...
  <div className="bf-card">
    <strong>Copy a workflow</strong>
    Workflow examples show complete package files and app calls without pulling private product implementation details into public docs.
  </div>
  <div className="bf-card">
...
- Want a complete example: [Workflow examples](/workflows/index)
