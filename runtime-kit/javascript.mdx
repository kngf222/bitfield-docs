...
| Give an AI agent rails. | [Build with AI agents](/runtime-kit/ai-build-rules) | It tells agents what they may edit and what they must not cross. |
...
That tiny contract prevents three common failures: app code reading package files, buttons importing target implementations, and AI agents inventing a second data path.
