...
If you want the full build path first, read [Package to screen](/runtime-kit/package-to-screen). It walks through the first complete Runtime Kit feature: package folder, boundary file, package admission, prepared read, target request, React surface, verification, and failure checks.
