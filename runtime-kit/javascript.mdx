...
| Keep generated changes inside the public files and names. | [Build with coding tools](/runtime-kit/ai-build-rules) | Use this only when an AI coding tool is writing the feature. |
...
package owns the data and work behind that public files and names
```
...
| Keep AI-written changes inside the public files and names | [Build with coding tools](/runtime-kit/ai-build-rules) |
