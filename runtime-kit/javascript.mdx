...
| Keep generated changes inside the public boundary. | [Build with AI agents](/runtime-kit/ai-build-rules) | Use this only when an AI coding tool is writing the feature. |
...
| Keep AI-written changes inside the public boundary | [Build with AI agents](/runtime-kit/ai-build-rules) |
