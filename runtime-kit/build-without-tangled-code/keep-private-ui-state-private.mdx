...
Product scene: a sidebar has hover state, an editor has unsaved text, a file tree has a selected file, and an assistant panel needs the selected file for context. These are not the same kind of state.
...
Traditional feature request: "When the user clicks a file row, highlight it, open it in the editor, and show the assistant panel context."
