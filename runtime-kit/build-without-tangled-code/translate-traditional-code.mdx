...
|---|---|---|
| Let many packages know the same selected file. | Put it in one feature store and import that store everywhere. | Put the selected file in Bitfield state and read the named input. |
...
The shell knows how to place entries. It does not know each package's private screens, stores, actions, or file layout.
