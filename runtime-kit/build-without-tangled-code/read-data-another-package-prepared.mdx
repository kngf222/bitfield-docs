...
|---|---|
| Does the consumer import the package that prepared the data? | No. It reads a prepared input. |
...
Traditional feature request: "Show the preview URL beside the current file and include help text if the user opens the command palette."
...
The consumer reads three public handles. Each preparing package can change its private code without forcing this panel to change.
