...
If consumer code says `import ... from '../other-package'`, ask why. A consumer package should receive a prepared input or a target name. It should not inspect another package's source files.
