...
| A feature gets added quickly. | Create a new store/service because that is the familiar app pattern. | Classify state, prepared data, work, UI-only state, and package material before code. |
...
| An AI coding tool keeps writing traditional architecture. | [Rules for AI agents](/runtime-kit/build-without-tangled-code/rules-for-ai-agents) |
