...
Expected result: after reading this section, you can see a normal app-code instinct and translate it into the Bitfield shape without guessing, importing private code, or making React the architecture.
...
Most public examples teach traditional app code: stores, services, imports, reducers, contexts, and direct calls.
...
| Generated code keeps writing traditional architecture. | [Rules for AI agents](/runtime-kit/build-without-tangled-code/rules-for-ai-agents) |
