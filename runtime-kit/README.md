...
- `ai-build-rules.mdx` gives AI-coding-tool-safe Runtime Kit build rules.
...
Runtime Kit pages must be useful to a human developer and to an AI coding tool reading the docs before editing code. Each guide should name the product moment, public files and names, files or calls the reader owns, expected result, common failures, and next link.
