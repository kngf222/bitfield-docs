...
- `cost-aware-building.mdx` explains when Runtime Kit sends Bitfield envelope bytes, when to use static/ordinary hosted output, and how billing follows runtime requests instead of public traffic.
