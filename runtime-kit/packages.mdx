...
<p className="bf-lead">
A Runtime Kit package is a folder with one public files and names file. That file tells Bitfield what to store, which bytes the package owns, and which callable doors the package exposes.
</p>
...
The package file declares data and callable doors. App code should still use Runtime Kit read/request calls.
