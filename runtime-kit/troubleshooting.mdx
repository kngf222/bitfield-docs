...
| AI-generated code imports deep Runtime Kit files. | App boundary violation. | Import list and files changed. |
...
Generated code tends to connect things directly when the boundary is not repeated clearly. Use [Build with AI agents](/runtime-kit/ai-build-rules) when code is being generated.

Use this rejection note when reviewing AI output:
...
That gives support, developers, and generated-code review the same map without exposing local state contents or private implementation files.
