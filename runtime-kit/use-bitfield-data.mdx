...
The component asks for data by using the hook. Runtime Kit decides what data name that component is allowed to read. The component receives the latest app-facing value.
...
The component is doing real work, but it still only knows data names, an action name, and public payload shapes.
