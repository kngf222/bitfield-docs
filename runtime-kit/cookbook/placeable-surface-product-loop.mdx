...
Before you accept the feature, check the product loop against this list. Use the same checklist for teammate code, your own code, or AI-written code.
...
Before accepting a product loop from this recipe, require this answer:
