...
<p className="bf-lead">
This Runtime Kit Cookbook entry builds the same shape explained in [Placeable surfaces](/runtime-kit/placeable-surfaces): package material becomes prepared reads and targets, descriptors declare what each surface may touch, and a dumb shell places the surfaces.
</p>
