...
| Component code creates storage addresses | The hook was treated like a database query. | Move back to the prepared input contract. |

## Review checklist

Before accepting this surface, answer:
