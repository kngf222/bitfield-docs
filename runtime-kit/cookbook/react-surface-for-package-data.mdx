...
The point is the separation: the component owns UI state and user actions. Runtime Kit owns the public read/request line. The package owns the material served through that line.
...
The selector is not a storage path. The component does not import the package record, file, or derived value that produced the data name.
