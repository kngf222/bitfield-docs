...
An AI agent needs rails. Without rails, it will choose the fastest-looking direct dependency: import unpublished code, parse files in UI code, wire features directly together, or create a second data path. That can work for one screen and punish you later.
...
React renders named data. Package admission belongs in Runtime Kit, not app components.
