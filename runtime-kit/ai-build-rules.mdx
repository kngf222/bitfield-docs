...
An AI agent needs rails. Without rails, it will choose the fastest-looking shortcut: import unpublished code, parse files in UI code, wire features directly together, or create a second data path. That can work for one screen and punish you later.
