...
<div className="bf-grid">
  ...
  <div className="bf-card">
    ...
    The app-facing package. Your app reads prepared data and sends named requests through it.
  </div>
  <div className="bf-card">
    <strong>Slot.</strong>
...
| The UI owns storage details | Screens become hard to move | Runtime Kit gives the UI prepared data and targets |
