...
Product scene: you want the headline numbers, but you also want to know what each number is allowed to mean.
...
Expected result: every row can be traced to the [Claim ledger](/reference/claim-ledger) before it is quoted.
