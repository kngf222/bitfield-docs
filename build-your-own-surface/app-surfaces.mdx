...
The screen should render a real product list, survive loading and error states, and send one named product action without knowing how Bitfield stores or runs the feature.
