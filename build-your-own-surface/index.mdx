...
This section also does not ask the shell to become smart. The shell should know placement, navigation, account state, and device state. The package surface should own the feature UI and data it renders. The callable target should own the requested action.
...
| Read raw package material in app code | The app learns storage layout instead of a public data name | Use named data reads through the public Runtime Kit surface |
