...
Expected result: the same shape scales from a tiny private tool to a product with many features because each feature can keep its package file, surface, and action reply shape clear.
...
| Read raw package material in app code | The app learns storage shape instead of product meaning | Use named data reads through the public Runtime Kit surface |
