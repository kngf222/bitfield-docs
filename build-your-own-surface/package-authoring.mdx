...
By the end, a reader can see the feature boundary before reading the React component. The package says what product material exists and which named action can be called.
