...
The machine-readable public schema lives at [`reference/package-boundary.schema.json`](/reference/package-boundary.schema.json). Workflow examples are checked against that schema during `docs:check`.
