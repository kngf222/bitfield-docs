...
The machine-readable public schema lives at [`reference/package-boundary.schema.json`](/reference/package-boundary.schema.json). Cookbook are checked against that schema during `docs:check`.
