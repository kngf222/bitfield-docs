...
The machine-readable public schema lives at [`reference/package-boundary.schema.json`](/reference/package-boundary.schema.json). Runtime Kit Cookbook recipes are checked against that schema during `docs:check`.
