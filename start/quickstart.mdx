...
Product scene: you are building the first screen of a product. It needs one piece of named data and one button that asks Bitfield to do work.
...
Expected result: your app can render one prepared value and send one action request without importing private package setup.
...
Visible result: the screen shows an inbox count when the named data is available. The component owns loading, error, and success rendering. It does not decide how Bitfield stores or prepares the data.
