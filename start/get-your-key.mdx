...
Product scene: you want to try Bitfield on the device in front of you. You need account access first, then device activation, then Runtime Kit can run against that account path.
...
Expected result: your account portal shows the account, plan/trial state, available active-device count, and the current way to activate this device.
